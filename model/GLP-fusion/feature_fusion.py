...
class PyramidFusionModule(nn.Module):
    ...
    def forward(self, x1, x2, return_visuals=False):
        ...
        feat_4_perm = feat_8_trans[:, 1:, :].permute(0, 2, 1)  # [b,128,8]
        feat_down_4 = self.down_projections[1](feat_4_perm)  # [b,128,4]
        ...
        feat_2_perm = feat_4_trans[:, 1:, :].permute(0, 2, 1)  # [b,128,4]
        feat_down_2 = self.down_projections[2](feat_2_perm)  # [b,128,2]
