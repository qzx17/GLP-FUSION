...
def evaluate(model, test_data, test_data_sl, test_label, criterion_cls, freq_min, freq_max, tensor_height, sampling_frequency):
    """
    ...
    # print("test_data_sl shape:",test_data_sl.shape)
    ...
    with torch.no_grad():
        Cls = model(test_data, cwt_representations_test, test_data_sl)
