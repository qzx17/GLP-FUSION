...
if __name__ == "__main__":
    ...
    config = load_config('/code/SL_TCCT_Net-main_EmotiW_test/config.json')
    ...
    y_true, y_pred = train(
        ...
        behavioral_features_sl=config['behavioral_features_sl'],
        train_folder_path=config['train_folder_path'],
        val_folder_path=config['val_folder_path'],
        test_folder_path = config['test_folder_path'],
        train_folder_path_sl=config['train_folder_path_sl'],
        val_folder_path_sl=config['val_folder_path_sl'],
        test_folder_path_sl = config['test_folder_path_sl'],
